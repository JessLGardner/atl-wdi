...
9. SELECT name FROM players ORDER BY salary LIMIT 1;
...
13. SELECT SUM(players.salary) FROM players, teams WHERE players.team_id=teams.id AND teams.name LIKE 'New York Giants';
